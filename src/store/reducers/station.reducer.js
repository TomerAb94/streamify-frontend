...
function unitTestReducer() {
    ...
    const station1 = { _id: 'b101', title: 'Station ' + parseInt('' + Math.random() * 10), owner: null, msgs: [] }
    const station2 = { _id: 'b102', title: 'Station ' + parseInt('' + Math.random() * 10), owner: null, msgs: [] }
    ...
    state = stationReducer(state, { type: UPDATE_STATION, station: { ...station2, title: 'Good' } })
